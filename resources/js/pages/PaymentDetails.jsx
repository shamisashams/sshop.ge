                                    ...
                                    <div className="max-w-md mx-auto">
                                        ...
                                        <div className="flex items-center justify-between mb-6">
                                            ...
                                            <div>
                                                <span className="opacity-50 ">
                                                    {__(
                                                        "client.cards_we_accept",
                                                        localizations
                                                    )}
                                                </span>
                                                <img
                                                    className="inline-block ml-1"
                                                    src="/client/assets/images/banks/1c.png"
                                                    alt=""
                                                />
                                                <img
                                                    className="inline-block ml-1"
                                                    src="/client/assets/images/banks/2c.png"
                                                    alt=""
                                                />
                                                <img
                                                    className="inline-block ml-1"
                                                    src="/client/assets/images/banks/3c.png"
                                                    alt=""
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap justify-center gap-4 mt-6">
                                            <button
                                                ...
                                                className={` px-3 text-center mb-3 rounded-xl bg-white  border-solid border-2  h-16   transition-all  shadow-lg hover:border-zinc-300  ${
                                                    bankSelect === 1
                                                        ? "!border-custom-blue"
                                                        : "border-white"
                                                }`}
                                            >
                                                <img
                                                    className={`  mx-auto `}
                                                    src="/client/assets/images/banks/2.png"
                                                    alt=""
                                                />
                                            </button>
                                            <button
                                            ...
                                            >
                                                <img
                                                    className={`  mx-auto `}
                                                    src="/client/assets/images/banks/1.png"
                                                    alt=""
                                                />
                                            </button>
                                        ...
                                        <div className="flex flex-wrap justify-center gap-4 mt-6">
                                            ...
                                            >
                                                <img
                                                    className={`  mx-auto `}
                                                    src="/client/assets/images/banks/terra.png"
                                                    alt=""
                                                />
                                            </button>
                                        ...
                                        >
                                            <img
                                                className=""
                                                src="/client/assets/images/icons/enter.png"
                                                alt=""
                                            />
                                        </button>
                                        ...
                                        <button
                                            onClick={makeOrder}
                                            className="w-full bold text-white bg-custom-blue rounded-xl py-5"
                                        >
                                            {__(
                                                "client.make_payment",
                                                localizations
