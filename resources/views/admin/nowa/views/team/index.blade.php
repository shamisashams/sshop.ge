...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">@lang('admin.team')</span>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <a href="{{locale_route('team.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.create')</a>
                                    ...
                                    @foreach($data as $slider)
                                        <tr>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            @foreach(config('translatable.locales') as $locale)
                                                                <div class="tab-pane {{$loop->first?"active":""}}" id="cat-{{$locale}}-{{$slider->id}}">
                                                                    {{$slider->translate($locale)->name ?? ''}} {{$slider->translate($locale)->surname ?? ''}}
                                                                </div>
                                                            @endforeach
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('team.edit',$slider->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>
                                                <a href="{{locale_route('team.destroy',$slider->id)}}"
