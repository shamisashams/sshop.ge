...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$model->created_at ? __('admin.contact-update') : __('admin.contact-create')}}</span>
        </div>
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                {!! Form::label($locale.'[address]',__('admin.address'),['class' => 'form-label']) !!}
                                                {!! Form::text($locale.'[address]',$model->translate($locale)->address ?? '',['class' => 'form-control']) !!}
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {!! Form::label("lat",__('admin.lat'),['class' => 'form-label']) !!}
                        {!! Form::text("lat",$model->options ?$model->options->coordinates->lat: '',['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label("lng",__('admin.lng'),['class' => 'form-label']) !!}
                        {!! Form::text("lng",$model->options ?$model->options->coordinates->lng: '',['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        <label class="form-label">@lang('admin.working_hours')</label>
                        <input type="text" class="form-control" name="working_hours" value="{{$model->working_hours}}">
                        @error('working_hours')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="phone">{{$model->phone}}</textarea>
                        @error('phone')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
