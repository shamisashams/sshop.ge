        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <a href="{{locale_route('collection.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.createbutt')</a>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('collection.edit',$item->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>
                                                <a href="{{locale_route('collection.destroy',$item->id)}}"
