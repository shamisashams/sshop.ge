...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">@lang('admin.stocks')</span>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('admin.stocks')</h4>
                    </div>
                    <a href="{{locale_route('stock.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.create')</a>
                                    ...
                                    @foreach($data as $slider)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('stock.edit',$slider->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>
                                                <a href="{{locale_route('stock.destroy',$slider->id)}}"
